...
QT_MOC_LITERAL(1, 5, 16), // "back_btn_clicked"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Info\0back_btn_clicked\0"
};
...
void Info::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->back_btn_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Info::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Info::back_btn_clicked)) {
                *result = 0;
                return;
            }
        }
