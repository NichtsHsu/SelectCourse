...
public:
    ...
    void addNewLesson(QString name, QString ID, QString deptment, double credit, QString description); // 新增课程
    void addNewTeacher(QString name, QString ID, QString deptment, QString description);  // 新增讲师
    void addNewStudent(QString name, QString ID, QString deptment, QString password);  // 新增学生
